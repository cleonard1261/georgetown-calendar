...
class Calendar(object):
    ...
    def remove_event(self, eventdate, eventname, calname):
        gtdir = '/Users/chadleonard/venv/calendar_app/georgetown_calendar/gtcal/'
        file_name = gtdir + calname + '.csv'
        output_file = gtdir + calname + 'Temp.csv'
...
if __name__ == '__main__':
    ...
    event2 = Event("Cal Test Event Two", '2014-04-03', "14:30")
